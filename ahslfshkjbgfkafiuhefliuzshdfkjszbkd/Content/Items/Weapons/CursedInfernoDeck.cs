...
{
    public class CursedInfernoDeck : ModItem
    { //explodes and applies Cursed Inferno debuff
        public override void SetDefaults()
        {
            ...
            Item.value = Item.sellPrice(gold: 2, silver: 60, copper: 64);

            Item.shoot = ModContent.ProjectileType<Projectiles.CursedInfernoDeckProjectile>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            magicDeck.AddIngredient(ModContent.ItemType<InfernoDeck>());
            magicDeck.AddIngredient(ItemID.CursedFlame, 20);
            magicDeck.AddTile(TileID.CrystalBall);
            magicDeck.Register();
        }
