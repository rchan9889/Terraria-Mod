...
{
    public class GoldenInfernoDeck : ModItem
    { //explodes and applies Ichor debuff
        public override void SetDefaults()
        {
            ...
            Item.value = Item.sellPrice(gold: 2, silver: 74, copper: 4);

            Item.shoot = ModContent.ProjectileType<Projectiles.GoldenInfernoDeckProjectile>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            magicDeck.AddIngredient(ItemID.Ichor, 20);
