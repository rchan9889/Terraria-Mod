...
namespace ahslfshkjbgfkafiuhefliuzshdfkjszbkd.Content.Projectiles
{
    ...
    public class HallowedGold : ModProjectile
    {
        ...
        {  
            ...
            Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, 15, 0f, 0f, 100, Color.Yellow, 2f);
			dust.noGravity = true;
            dust.velocity *= 5f;
        }
        public override void OnKill(int timeLeft)
        {
            ...
            for(int i = 0; i < 10; i++){
                int dust2 = Dust.NewDust(Projectile.position, Projectile.width+24, Projectile.height, 15, 0f, 0f, 100, Color.Yellow, 1);
            }
        }
    }
}