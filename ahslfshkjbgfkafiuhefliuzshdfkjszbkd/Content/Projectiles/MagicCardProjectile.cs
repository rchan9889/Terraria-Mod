...
namespace ahslfshkjbgfkafiuhefliuzshdfkjszbkd.Content.Projectiles
{
    ...
    public class MagicCardProjectile : ModProjectile
    {
        ...
        {  
            ...
            Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, 15, 0f, 0f, 100, Color.Purple, 2f);
			dust.noGravity = true;
            dust.velocity *= 5f;
        }
        public override void OnKill(int timeLeft)
        {
            ...
            for(int i = 0; i < 10; i++){
                int dust2 = Dust.NewDust(Projectile.position, Projectile.width+24, Projectile.height, 15, 0f, 0f, 100, Color.Purple, 1);
            }
        }
    }
}